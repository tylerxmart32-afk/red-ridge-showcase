...
export function ServiceCard({ icon: Icon, title, description, features }: Service) {
  return (
    <article className="group relative flex h-full flex-col rounded-2xl border border-border bg-surface p-6 transition-all duration-300 hover:-translate-y-1 hover:border-primary hover:bg-accent/50">
